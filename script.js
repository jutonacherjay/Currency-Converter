...
dropdowns.forEach(dropdown => {
    for (let currency in countryList) {
        ...
        // Check the name attribute of the current dropdown element
        if (dropdown.name === "from" && currency === "USD") {
            newOption.selected = "selected";
        } else if (dropdown.name === "to" && currency === "INR") {
            newOption.selected = "selected";
        }
    ...
    // Add event listener to the current dropdown element
